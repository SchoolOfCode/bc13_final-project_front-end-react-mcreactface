        ...
        <div className={styles.container}>
            ...
            <div className={styles.scrolling}>
                ...
                <div className={styles.sidetext}>
                    <p>
                        <b>Looking for a gig? Book your gig with ease. MusoFind has
                        a simple booking system that allows you to book gigs
                        with just a few clicks. No more hassle of emailing
                        back and forth. Just book your gig and get to playing.</b>
                        <b className={styles.presponsivechange}>The My Gigs page allows you to see all the gigs you have
                        ...
                        and your schedule at your fingertips.</b>
                    </p>
                    </div>
